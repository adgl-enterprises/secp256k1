...
static int secp256k1_generator_generate_internal(const secp256k1_context* ctx, secp256k1_generator* gen, const unsigned char *key32) {
    ...
    secp256k1_zkp_sha256_write(ctx, &sha256, prefix1, 16);
    secp256k1_zkp_sha256_write(ctx, &sha256, key32, 32);
    secp256k1_zkp_sha256_finalize(ctx, &sha256, b32);
    ...
    secp256k1_zkp_sha256_initialize(ctx, &sha256);
    secp256k1_zkp_sha256_write(ctx, &sha256, prefix2, 16);
    secp256k1_zkp_sha256_write(ctx, &sha256, key32, 32);
    secp256k1_zkp_sha256_finalize(ctx, &sha256, b32);
    ret &= secp256k1_fe_set_b32(&t, b32);
    if (!ret) {
...
int secp256k1_generator_generate(const secp256k1_context* ctx, secp256k1_generator* gen, const unsigned char *key32) {
    ...
    return secp256k1_generator_generate_internal(ctx, gen, key32);
}
...
int secp256k1_generator_generate_blinded(const secp256k1_context* ctx, secp256k1_generator* gen, const unsigned char *key32, const unsigned char *blind32) {
    ...
    if (!secp256k1_generator_generate_internal(ctx, gen, key32)) {
        return 0;
    }
    ...
    if (secp256k1_scalar_is_zero(&blind)) {
        return secp256k1_generator_generate_internal(ctx, gen, key32);
    }
    secp256k1_generator_load(&ge, gen);
    secp256k1_gej_set_ge(&gej, &ge);
    secp256k1_ecmult(&gej, &gej, &secp256k1_scalar_one, &blind);
