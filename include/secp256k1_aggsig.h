#ifndef SECP256K1_AGGSIG_H
#define SECP256K1_AGGSIG_H
...
/** MWEB single-signer workflow (Litecoin libmw):
 *
 *      1. `secp256k1_aggsig_export_secnonce_single` — exchange secret nonces off-chain
 *      2. `secp256k1_aggsig_sign_single` — sign with optional `pubnonce_total` / `pubnonce_for_e`
 *      3. `secp256k1_aggsig_add_signatures_single` — combine partial signatures
 *      4. `secp256k1_aggsig_verify_single` — verify
 */
